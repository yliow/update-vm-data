...
def graph(shape='circle',
    ...
    # ADDED now overwrite with args
    #print("args.items:", args.items())
...
\li This is a closed-book, no-discussion, no-calculator, no-compiler
    test.
...
\textsc{Honor Statement}
\end{center}
I, \answerbox{\textwhite{[$\Biggl|$ REPLACE WITH YOUR FULLNAME]}} \ \ (print your name),
attest to the fact that the submitted work is my own and
is not the result of plagiarism.
Furthermore, I have not aided another student in the act of
plagiarism.
\\
Signature: \answerbox{\textwhite{[$\Biggl|$REPLACE WITH YOUR FULLNAME]}}
''')
